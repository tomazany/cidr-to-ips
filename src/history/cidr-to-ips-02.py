...
def count_unique_ips_and_display_ranges(cidr_list=None, file_path=None):
    ip_set = set()
    cidr_info = []
...
# count_unique_ips_and_display_ranges(cidr_list=cidr_input)

# Count unique IPs for a file input
print("Unique IPs (file input):")
count_unique_ips_and_display_ranges(file_path=file_path)
